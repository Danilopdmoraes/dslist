...
public class Game {
	...
	//  4 - Getters and Setters (gerados automaticamente (...source/generate getters and setters))
	public Long getId() {
		return id;
	}
	...
	// 5 - hashCode() and equals() (gerados automaticamente ...source / generate hashCode() and Equals()):
	@Override
	public int hashCode() {
